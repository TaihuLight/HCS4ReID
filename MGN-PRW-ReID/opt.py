...
parser.add_argument('--data_path',
                    default="/media/chengzi/FT-data/Market-1501-v15.09.15",
                    help='path of Market-1501-v15.09.15')

parser.add_argument('--mode',
                    default='evaluate', choices=['train', 'evaluate', 'vis'],
                    help='train or evaluate ')

parser.add_argument('--query_image',
                    default='/media/chengzi/FT-data/Market-1501-v15.09.15/query/0001_c1s1_001051_00.jpg',
...
parser.add_argument('--weight',
                    default='weights/model_ReID_mgn_prw.pt',
                    help='load weights ')
