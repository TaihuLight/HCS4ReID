...
#         gf = extract_feature(self.model, tqdm(self.test_loader)).numpy()
        ...
        print('Extracting features is finished')
        def rank(dist):
...
if __name__ == '__main__':
    ...
    opt.mode = 'evaluate'
    # PRW dataset root path
    opt.data_path ='/media/chengzi/FT-dataset/PRW-Market'
    ...
    if opt.mode == 'evaluate':
        print('Start ReID-MGN evaluate on CS constructed Gallery bboxes using ISTA-Net with two MRs.')
